        ...
        const Locator& locator)
{
    ...
    if (IPLocator::isAny(locator))
    {
        ...
        for (const auto& infoIP : locNames)
        {
            ...
            if (is_interface_allowed(ip))  // TODO: change
            {
        ...
        const Locator& locator) const
{
     ...
     */
    for (const IPFinder::info_IP& localInterface : current_interfaces_) // TODO: deprecate?
    {
        ...
        const Locator& locator) const
{
    ...
    return is_interface_allowed(locator);  // TODO: change: insert here logic of is_interface_allowed (the name of the latter function does not make sense given what it does)
}
